...
import { FormControl, Validators, ValidationErrors, AbstractControl, FormBuilder } from '@angular/forms';
	...
	ngOnInit(): void {
		...
		this.store.dispatch(
			MainStateAction.TestRequest({
				// link:'REST.svc/TraineeSchedule/405c8061-2dd1-e411-8e96-d8d385fcda38/2c42ab6f-1ed2-e411-8e96-d8d385fcda38/secretariat/03-aug-2015/425de1b9-338f-4912-b735-cb2712a8f07f',
