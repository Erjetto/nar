...
System.Security.Cryptography.CryptoStream = function (stream, transform, mode) {
	...
	let _partialCount = 0;
	let _endOfStream = false;
	let _waitingBlock = new Array();
	let _waitingCount = 0;
	let _transformedBlock = new Array();
	let _transformedPos = 0;
	let _transformedCount = 0;
